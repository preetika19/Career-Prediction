#to obtain personality of Lawyers
...
def getTweets(user):
	csvFile = open('lawyerstweets.csv', 'a', newline='')
...
print("Myers-Briggs Personality Indicator for LAWYERS: E-Extraversion/I-Introversion S-Sensing/N-Intuition T-Thinking/F-Feeling J-Judgement/P-Perception")

account=["@AlanDersh","@BryanAGarner","@nikiblack","@LeanLawStrategy","@bobambrogi","@zanneslaw",
         "@AndrewArruda","@StaceyEBurke","@NancyGrace","@markgeragos","@RachelGurvich","@glambert",
         "@sarahjeong","@associatesmind","@rightbrainlaw","@kevinokeefe","@DavidLat","@Sifill_LDF",
         "@SamanthaJPower","@RealJudgeLynn"]

for j in range(0,20):
    print(j)
    username=account[j]
    getTweets(username)
with open('lawyerstweets.csv','rt') as f:

#to obtain personality of Musicians
...
def getTweets(user):
	csvFile = open('musiciantweets.csv', 'a', newline='')
...
print("Myers-Briggs Personality Indicator for MUSICIANS: E-Extraversion/I-Introversion S-Sensing/N-Intuition T-Thinking/F-Feeling J-Judgement/P-Perception")

account=["@justinbieber","@ladygaga","@katyperry","@rihanna","@taylorswift13","@britneyspears","@shakira",
         "@jtimberlake","@JLo","@NICKIMINAJ","@BrunoMars","@Pink","@selenagomez","@Drake","@ArianaGrande",
         "@Adele","@aliciakeys","@chrisbrown","@Harry_Styles","@MileyCyrus"]

for j in range(0,20):
    print(j)
    username=account[j]
    getTweets(username)
with open('musiciantweets.csv','rt') as f:

#to obtain personality of Politicians
...
def getTweets(user):
	csvFile = open('politciantweets.csv', 'a', newline='')
...
print("Myers-Briggs Personality Indicator for POLITICIANS: E-Extraversion/I-Introversion S-Sensing/N-Intuition T-Thinking/F-Feeling J-Judgement/P-Perception")

account=["@realDonaldTrump","@Pontifex","@narendramodi", "@RT_Erdogan","@SushmaSwaraj","@jokowi","@QueenRania",
         "@HHShkMohd","@ImranKhanPTI","@KingSalman","@MedvedevRussia","@lopezobrador_","@mauriciomacri",
         "@JustinTrudeau","@ABZayed","@EmmanuelMacron","@KremlinRussia","@SBYudhoyono","@NicolasMaduro",
         "@jairbolsonaro"]
for j in range(0,20):
    print(j)
    username=account[j]
    getTweets(username)
with open('politciantweets.csv','rt') as f:

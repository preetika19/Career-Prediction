#to obtain personality of Doctors
...
def getTweets(user):
	csvFile = open('doctorstweets.csv', 'a', newline='')
...
print("Myers-Briggs Personality Indicator for DOCTORS: E-Extraversion/I-Introversion S-Sensing/N-Intuition T-Thinking/F-Feeling J-Judgement/P-Perception")

account=["@berci","@kevinmd","@DrOz","@DrLeslieSaxon","@zdoggmd","@DrMikeSevilla","@drval",
         "@JuliekWoodMD","@GrStream","@DrJosephKim","@CLflickMD","@MrsBrull","@KennyLinAFP",
         "@FamilyDocWonk","@TroyTXfamilyDoc","@BlackwelderMD","@EricTopol","@RichmondDoc",
         "@ApJonas","@DocCottle"]
...
for j in range(0,20):
    ...
    username=account[j]
    getTweets(username)
with open('doctorstweets.csv','rt') as f:

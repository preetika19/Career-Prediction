#to obtain personality of Pilots
...
def getTweets(user):
	csvFile = open('pilotstweets.csv', 'a', newline='')
...
print("Myers-Briggs Personality Indicator for PILOTS: E-Extraversion/I-Introversion S-Sensing/N-Intuition T-Thinking/F-Feeling J-Judgement/P-Perception")

account=["@BenetWilson","@flyingwithfish","@danwebbage","@roncallari","@aschonland","@BLRAviation",
         "@RunwayGirl","@crankyflier","@flightblogger","@rickseaney","@MiddleSeat","@StarVillanueva",
         "@BethanyinFL","@Heather_Poole","@FlyAArmy","@theflyingpinto","@Sodwee",
         "@TraytablesTrvls","@flyheatherfly","@skysteward"]

for j in range(0,20):
    print(j)
    username=account[j]
    getTweets(username)
with open('pilotstweets.csv','rt') as f:

#to obtain personality of Entrepreneurs
...
def getTweets(user):
	csvFile = open('entrepreneurstweets.csv', 'a', newline='')
...
print("Myers-Briggs Personality Indicator for ENTREPRENEURS: E-Extraversion/I-Introversion S-Sensing/N-Intuition T-Thinking/F-Feeling J-Judgement/P-Perception")

account=["@msuster","@richardbranson","@sgblank","@GuyKawasaki","@smallbiztrends","@fredwilson",
         "@bijan","@Timberry","@Bernadeen","@ThisIsSethsBlog","@davidhornik","@Caterina","@bfeld",
         "@BrandYou","@joshk","@edsim","@jeremysliew","@loic","@jasonfried"]

for j in range(0,19):
    print(j)
    username=account[j]
    getTweets(username)
with open('entrepreneurstweets.csv','rt') as f:
